...
figS2A <- ggetho(dt, aes(z = moving), multiplot = 2) +
...
figS2B <- ggperio(per_dt, aes(y = power, peak = peak)) + 
...
#=================================================
figS2A <- figS2A +  theme(strip.text.x = element_text(size =8))
figS2B <- figS2B +  theme(strip.text.x = element_text(size =8))
