...
summary_dt <- per_dt[,.(
                        ...
                        first_peak_rel_power = power[peak==1] - signif_threshold[peak==1],
...
The result shows a strong positive effect of genotype Tim/NKCCOX on the probability of being rhythmic ($p$-value \Sexpr{str}):
