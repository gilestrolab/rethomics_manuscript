...
Scripting interfaces are the standard in data sciences and statistics since they help to deliver reproducible results \cite{peng_reproducible_2011,stodden_toward_2013}.
