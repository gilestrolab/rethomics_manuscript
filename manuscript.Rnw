...
The significANCE AND determinism OF ANIMAL BEHAVIOUR has long been question of prime interest.
In the 1960-70s genetics and behaviour inerpenetrated as researchers started to identify genetic determinant of behaviours.
OUr ability to understand genetics and neurobiology has been enpowered by new high throughput methods and data analysis.
