...
Indeed, many platforms (\citationneeded{}) have been developed in order to allow biologists to continuously record behaviours such as activity, position\cite{geissmann_ethoscopes:_2017} and feeding\cite{itskov_automated_2014} of multiple animals over long durations (days or weeks).
...
Instead, tools tend to consist of graphical interfaces that import data from a single platform and provide somewhat rigid functionalities \cite{gilestro_pysolo:_2009,schmid_new_2011-1}.
...
They include utilities to input new behaviour tracking methods and analyse position and multi-animal interaction.
...
Alice French, Hannah Jones and Diana Bicazan for her comments as early users.
...
Robert Dickinson, for his support.
