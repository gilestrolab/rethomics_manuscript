...
\hlstd{S2A_fig} \hlkwb{<-} \hlkwd{ggetho}\hlstd{(dt,} \hlkwd{aes}\hlstd{(}\hlkwc{z} \hlstd{= moving),} \hlkwc{multiplot} \hlstd{=} \hlnum{2}\hlstd{)} \hlopt{+}
...
\hlstd{S2B_fig} \hlkwb{<-} \hlkwd{ggperio}\hlstd{(per_dt,} \hlkwd{aes}\hlstd{(}\hlkwc{y} \hlstd{= power,} \hlkwc{peak} \hlstd{= peak))} \hlopt{+}
...
\begin{thebibliography}{10}
	...
	\bibitem{sokolowski_drosophila_2001}
	Sokolowski MB.
	\newblock {\emph{Drosophila}}: {{Genetics}} Meets Behaviour.
	\newblock Nature Reviews Genetics. 2001;2(11):879--890.
	\newblock doi:{10.1038/35098592}.
	
	\bibitem{stephens_big_2015}
	...
	\bibitem{schatz_biological_2015}
	Schatz MC.
	...
	\bibitem{sejnowski_putting_2014}
	Sejnowski TJ, Churchland PS, Movshon JA.
	\newblock {Putting big data to good use in neuroscience}.
	\newblock Nature Neuroscience. 2014;17(11):1440--1441.
	\newblock doi:{10.1038/nn.3839}.
	
	\bibitem{branson_high-throughput_2009}
	...
	\bibitem{swierczek_high-throughput_2011}
	...
	\bibitem{kabra_jaaba_2013}
	Kabra M, Robie AA, Rivera-Alba M, Branson S, Branson K.
	\newblock {{JAABA}}: Interactive Machine Learning for Automatic Annotation of
	Animal Behavior.
	\newblock Nature Methods. 2013;10(1):64--67.
	\newblock doi:{10.1038/nmeth.2281}.
	
	\bibitem{lopes_bonsai_2015}
	...
	\bibitem{geissmann_ethoscopes_2017}
	...
	\bibitem{huber_orchestrating_2015}
	...
	\bibitem{peng_reproducible_2011}
	Peng RD.
	...
	\bibitem{ogueta_maite_2018_1172980}
	Ogueta M, Stanewsky R.
	\newblock {{LL Behaviour}} of {{TIM Gal4}} $>$ {{NKCC OX}} and {{NKCC OX}} / +
	Flies.
	\newblock Zenodo. 2018;doi:{10.5281/zenodo.1172980}.
	
	\bibitem{aguiar-conraria_business_2011}
	...
	\bibitem{grossmann_decomposition_1984}
	...
	\bibitem{schmidbauer_waveletcomp_2018}
