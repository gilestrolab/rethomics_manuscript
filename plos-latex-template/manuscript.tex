...
\begin{figure}[!h]
	...
	\caption{{\bf Example of a \texttt{behavr} table.}
		...
		Its columns, the $p$ metavariables, are of two kind: either required and defined by the acquisition platform (\emph{i.e.} used to map the data) or user-defined (\emph{i.e.} arbitrary).
